...
import { ArrowLeft, BadgeCheck, BookOpen, Calendar, Check, MapPin, Users } from "lucide-react";
...
export const Route = createFileRoute("/pricing")({
  head: () => ({
    meta: [
      { title: "التسجيل — AbaTools" },
      {
        name: "description",
        content:
          "سجّل مقعدك في الدورة الحضورية. تدريب تفاعلي مع أدوات ورشة عمل وشبكات مهنية.",
      },
      { property: "og:title", content: "التسجيل — AbaTools" },
      {
        property: "og:description",
        content: "دورة حضورية بمقاعد محدودة. احجز مقعدك الآن.",
      },
    ],
  }),
      ...
      <section className="gradient-hero">
        <div className="container-x py-16 md:py-24">
          ...
          <p className="mt-5 text-lg text-muted-foreground leading-8 max-w-2xl">
            دورة تدريبية عملية من تأطير الخبيرة كوثر سامي، محللة سلوك معتمدة QBA،
        ...
        <div className="max-w-3xl mx-auto">
          <div className="card-elevated overflow-hidden">
            ...
            <div className="p-6 md:p-8 pt-0 md:pt-0">
              <a
                href="mailto:kaoutarsami@abatools.info?subject=طلب%20تسجيل%20في%20دورة%20ABAT"
              ...
              <p className="mt-3 text-center text-xs text-muted-foreground">
                بعد النقر سيتم فتح رسالة بريد تمهيدية. سنرسل لك تفاصيل الحجز خلال 48 ساعة عمل.
              </p>
            </div>
          </div>
        </div>
      ...
      <Section className="bg-surface">
        ...
        <div className="mt-8 grid gap-5 md:grid-cols-3">
          ...
          <div className="card-elevated p-6 text-center">
            ...
            <h3 className="mt-4 font-bold">تأطير معتمد</h3>
            <p className="mt-2 text-sm text-muted-foreground leading-6">
              من تأطير الخبيرة كوثر سامي، محللة سلوك معتمدة QBA، لضمان جودة التدريب.
            </p>
          </div>
          <div className="card-elevated p-6 text-center">
