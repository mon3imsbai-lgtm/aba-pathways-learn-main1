...
import qabaCredentialLogo from "../assets/qaba logo.png";
import qabaTrainingLogo from "../assets/logo qaba.png";
...
function Hero() {
  return (
    <section className="hero-bg py-12 md:py-16 lg:py-20">
      <div className="container-x">
        <div className="flex flex-col items-center gap-10 lg:flex-row lg:items-center lg:gap-16">
          <div className="w-full flex-1 space-y-6 lg:max-w-[58%]">
            ...
            <p className="max-w-lg text-base md:text-lg leading-8 text-muted-foreground">
              منصة عربية تقدّم إعلانات مبدئية عن دورات قادمة، استشارات أسرية ومهنية، كتب إلكترونية،
              حقائب تدريبية، وموارد رقمية قابلة للتحميل، بإشراف الخبيرة كوثر سامي محللة سلوك معتمدة
              QBA وأخصائية نفسية تربوية.
            </p>
            <div className="flex flex-wrap items-center gap-3 pt-2">
              ...
              <Link
                to="/contact"
                className="inline-flex items-center gap-2 rounded-full border border-border bg-background px-6 py-3 text-sm font-semibold text-foreground transition-all hover:bg-mint/25"
              >
                سجّل اهتمامك
          ...
          <div className="w-full lg:max-w-[40%]">
            <div className="overflow-hidden rounded-[30px] border border-border shadow-subtle">
              <img
                src={heroImg}
...
function Accreditations() {
  return (
    <section className="py-8 md:py-10">
      <div className="container-x">
        <div className="mx-auto max-w-5xl rounded-[24px] border border-border bg-background p-7 shadow-subtle md:p-10">
          <h2 className="text-center text-2xl font-extrabold text-foreground md:text-3xl">
            الاعتمادات والشهادات المهنية
          </h2>
          <p className="mt-2 text-center text-sm text-muted-foreground">
            كل برامجنا مبنية على معايير QABA العالمية مع إشراف علمي مباشر.
          </p>
          <div className="mt-6 grid divide-y divide-border md:divide-y-0 md:divide-x md:divide-border md:grid-cols-2 gap-6">
            <div className="flex flex-col items-center text-center py-2 md:py-0">
              <div className="logo-frame">
                <img
                  src={qabaCredentialLogo}
                  alt="Behavioral Health QABA Credentialing"
                  loading="lazy"
                  className="h-full w-full object-contain"
                />
              </div>
              <p className="mt-4 text-sm font-bold text-foreground">معتمد من QABA</p>
              <p className="mt-1.5 text-xs text-muted-foreground max-w-xs">
                اعتماد عالمي في تحليل السلوك التطبيقي
              </p>
            </div>
            <div className="flex flex-col items-center text-center py-2 md:py-0">
              <div className="logo-frame">
                <img
                  src={qabaTrainingLogo}
                  alt="QABA APPROVED TRAINING PROGRAM"
                  loading="lazy"
                  className="h-full w-full object-contain"
                />
              </div>
              <p className="mt-4 text-sm font-bold text-foreground">برنامج تدريبي معتمد من QABA</p>
              <p className="mt-1.5 text-xs text-muted-foreground max-w-xs">
                الالتزام بأعلى معايير الجودة والتدريب
              </p>
            </div>
          </div>
        </div>
...
const heroFeatures = [
  {
    icon: GraduationCap,
    title: "دورات معتمدة",
    desc: "دورات تدريبية عملية مع شهادات معتمدة",
  },
  { icon: Users, title: "استشارات متخصصة", desc: "جلسات فردية للأسر والمهنيين بإشراف خبراء" },
  { icon: FileText, title: "موارد رقمية غنية", desc: "كتب إلكترونية، نماذج وأدوات جاهزة للتحميل" },
];
    ...
    <Section className="bg-surface/50">
      <div className="grid gap-5 md:grid-cols-2 lg:grid-cols-3">
        {heroFeatures.map((f) => (
          <div
            key={f.title}
            className="flex flex-col items-center rounded-[22px] border border-border bg-background p-7 text-center shadow-subtle"
          >
            <span className="mint-circle h-12 w-12">
      ...
      <div className="grid gap-10 lg:grid-cols-[1fr_1.2fr] items-center">
        ...
        <div className="order-1 lg:order-2">
          ...
          <p className="mt-4 text-muted-foreground leading-8">
            ...
            التدريبية لضمان وضوح المعلومات وارتباطها بالممارسة المهنية والأسرية.
          </p>
...
const upcomingCourses = [
  {
    ...
    tag: "قريباً",
    desc: "المسار التأسيسي في تحليل السلوك التطبيقي.",
    hours: "40 ساعة",
  },
  {
    title: "QASP-S Preparation",
    tag: "قريباً",
    desc: "تحضير احترافي لاختبار QASP-S.",
    hours: "TBA",
  },
  {
    title: "QBA Preparation",
    tag: "قريباً",
    desc: "الإعداد لشهادة محلل السلوك المؤهل.",
    hours: "TBA",
  },
      ...
      <div className="mt-10 grid gap-5 md:grid-cols-2 lg:grid-cols-3">
        {displayCourses.map((c) => (
          <article key={c.title} className="card-elevated card-elevated-hover p-6 flex flex-col">
            ...
            <Link
              to="/courses"
              className="mt-5 text-sm font-semibold text-primary hover:underline inline-flex items-center gap-1"
            >
        ...
        <div className="grid lg:grid-cols-2 gap-8 items-center">
          <div className="p-8 md:p-12">
            ...
            <p className="mt-4 text-primary-foreground/85 leading-8">
              برنامج تدريبي منظّم يؤسس المتدرّب لفهم مبادئ تحليل السلوك التطبيقي والعمل مع الأطفال
              ذوي اضطراب طيف التوحد ضمن ممارسات مهنية واضحة.
            </p>
...
function ServicesPreview() {
      ...
      : [
          {
            icon: HeartHandshake,
            title: "للأسرة والطفل",
            desc: "إرشاد عملي لبناء روتين ودعم التواصل.",
          },
  ...
  return (
    <Section>
      <SectionHeader eyebrow="الخدمات والاستشارات" title="حلول تخدم الأسرة والأخصائي والمؤسسة" />
      ...
      : [
          {
            name: "أم يوسف",
            role: "ولية أمر",
            quote: "المحتوى واضح وعملي، ساعدنا في بناء روتين هادئ للبيت.",
          },
          {
            name: "سارة، أخصائية تربية خاصة",
            role: "أخصائية",
            quote: "أدوات التقييم ونماذج المتابعة وفّرت عليّ وقتاً كبيراً في التوثيق.",
          },
          {
            name: "مركز إنسان",
            role: "مؤسسة",
            quote: "برنامج تدريب الفريق كان منظّماً وواقعياً وسهّل توحيد الممارسة.",
          },
        ];
      ...
      <div className="mt-10 grid gap-5 md:grid-cols-3">
        {t.map((x) => (
          <figure key={x.name} className="card-elevated p-6">
            ...
            <blockquote className="mt-4 text-sm leading-7 text-foreground">«{x.quote}»</blockquote>
...
function FAQ() {
  ...
  const items =
    faqs && faqs.length > 0
      ...
      : [
          {
            q: "هل الدورات متاحة الآن؟",
            a: "الإعلانات حالياً مبدئية. سيُفتح التسجيل قريباً ونُعلن التواريخ عبر المنصة.",
          },
          {
            q: "هل المحتوى مناسب للأسر بدون خلفية مهنية؟",
            a: "نعم. لدينا مسار خاص بالأسر مبني بلغة واضحة وعملية.",
          },
          {
            q: "هل يمكن للمراكز التعاقد على تدريب فرق العمل؟",
            a: "نعم، نقدّم برامج مؤسسية مخصصة تشمل التدريب والسياسات وأدوات القياس.",
          },
          {
            q: "بأي لغة تُقدَّم الدورات؟",
            a: "العربية مع اعتماد المصطلحات الإنجليزية الأساسية في المجال.",
          },
        ];
