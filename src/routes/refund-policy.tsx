  ...
  head: () => ({
    meta: [
      { title: "سياسة استرجاع الأموال — AbaTools" },
      {
        name: "description",
        content:
          "تعرف على شروط وخطوات استرجاع مبلغ الدورة. يتم الإعادة حصراً عبر تحويل بنكي تقليدي.",
      },
          ...
          <div className="space-y-6">
            <div className="card-elevated p-6">
              ...
              <p className="text-sm text-muted-foreground leading-7">
                يحق للمُسجّل طلب استرجاع مبلغ الدورة الحضورية وفق الشروط المعلنة. نحرص على
                معالجة كل طلب بشفافية وإرسال التحويل البنكي بعد إتمام المراجعة الإدارية.
              </p>
            </div>
