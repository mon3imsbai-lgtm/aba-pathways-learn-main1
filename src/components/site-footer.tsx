...
import abatoolsLogo from "../assets/abatools-logo-stacked.png";
import qabaLogoSmall from "../assets/logo qaba.png";
    ...
    <footer className="mt-24 border-t border-border bg-surface-soft">
      <div className="container-x py-14 grid gap-10 md:grid-cols-4">
        <div className="md:col-span-2">
          <img src={abatoolsLogo} alt="AbaTools" className="h-24 w-auto" width={160} height={96} />
          <p className="mt-4 max-w-md text-sm leading-7 text-muted-foreground">
            منصة عربية للتدريب والاستشارات والموارد الرقمية في التوحد وتحليل السلوك التطبيقي، بإشراف
        ...
        <div className="container-x flex flex-col md:flex-row items-center justify-between gap-3 py-5 text-xs text-muted-foreground">
          ...
          <div className="flex items-center gap-2.5">
            <img
              ...
              height={24}
            />
            <span>بإشراف علمي من الخبيرة كوثر سامي — QBA</span>
          </div>
        </div>
      </div>
    </footer>
